...
], function (Controller, MessageToast, History, IconPool, StringType, ValidateException) {
	"use strict";

	return Controller.extend("de.enercon.usbee.controller.recordresults_list.DetailS1L_list", {

		onInit: function () {
			// IconPool.addIcon('sad2', 'customfont', 'sapbusiness', 'e087');
			// IconPool.addIcon('smile', 'customfont', 'sapbusiness', 'e08b');
			...
			oRouter.getRoute("Merkmal_S1_Qual_list").attachMatched(this._onRouteMatched, this);
		...
		// typeBemerkung: StringType.extend("Pb_text", {
		// 	//MESSWERT_REGEX: /^[0-9]+(\,[0-9]{1,3})?$/,
		// 	MESSWERT_REGEX: /^([A-Za-z0-9ÄÖÜäöüß]{5,40})$/,
		...
		// 				//expand: "TORESU/TOBEWERTE,TORESU/TOMERKMALE"
		// 		},
		// 		events: {
		...
		_onBindingChange: function (oEvent) {
			...
			//this.getView().byId("idresuTableL").getModel().refresh(true);
