sap.ui.define([
	...
	return Controller.extend("de.enercon.usbee.controller.recordresults_list.DetailNNN_list", {
		...
		onInit: function () {
			...
			oRouter.getRoute("Merkmal_NN_Quan_list").attachMatched(this._onRouteMatched, this);
