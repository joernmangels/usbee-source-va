sap.ui.define([
	...
	return Controller.extend("de.enercon.usbee.controller.recordresults_list.DetailCHL_list", {
		...
		onInit: function () {
			...
			oRouter.getRoute("Merkmal_CH_Qual_list").attachMatched(this._onRouteMatched, this);
