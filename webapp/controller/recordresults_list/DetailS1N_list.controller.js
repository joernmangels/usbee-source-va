sap.ui.define([
	...
	return Controller.extend("de.enercon.usbee.controller.recordresults_list.DetailS1N_list", {
		...
		onInit: function () {
			...
			oRouter.getRoute("Merkmal_S1_Quan_list").attachMatched(this._onRouteMatched, this);
		...
		typeMesswert: StringType.extend("Messwert", {
			...
			validateValue: function (oValue) {
				//var message = this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("detail1-mess_val_mess");
