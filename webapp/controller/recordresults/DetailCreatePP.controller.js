sap.ui.define([
	...
	return Controller.extend("de.enercon.usbee.controller.recordresults.DetailCreatePP", {
		...
		onInit: function () {
			...
			oRouter.getRoute("Prueflos_CreatePP").attachMatched(this._onRouteMatched1, this);
